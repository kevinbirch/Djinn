...
function
	:	DEF NAME (pattern=lambda)? LBRACK (body+=lambda | body+=atom)+ functions+=function* vardefs+=assignment_statement* RBRACK
...
single_assignment_statement
	:	DEF NAME literal -> ^(ASSIGNMENT NAME literal)
	;
